...
- ~~Vlastný parametrický engine mimo DC~~ — pôvodná úvaha o hybride (DC geometria + Ruby riadenie) bola PREKONANÁ: analýza `SYSTEM/archiv/02_ANALYZA_korpus_dc_vs_ruby.md` rozhodla o čistom Ruby generovaní (žiadne DC vzorce) — teda rovnaký prístup ako ArchiWood. V tomto bode ArchiWood v skutočnosti kopírujeme, cloud backend nie.
