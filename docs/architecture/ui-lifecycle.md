...
v súradniciach korpusu** (z od podlahy), takže JS nič nescitáva. Geometriu dáva **tá istá funkcia, z ktorej kreslí builder** (`Construction.appliance_niche_references`),
