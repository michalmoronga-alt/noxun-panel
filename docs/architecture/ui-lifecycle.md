...
**Návrh a potvrdenie (D-120, v0.10.7):** `front_preflight` je čistý callback Panelu nad aktuálnymi rozmermi/fronts, vracia resolved riadky, fyzické hrany, smerové sloty
