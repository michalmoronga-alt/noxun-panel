...
| Kontrola rozmerov | vo V1 **len chladnička a umývačka** (jednoduché; chladnička = pre každý rozmer niky `min ≤ vnútro ≤ max`, umývačka = len šírka slotu); **rúra a mikrovlnka zatiaľ nie** (previazané rozmery, presahy, rúra + mikro nad sebou) — až po predúlohe |
