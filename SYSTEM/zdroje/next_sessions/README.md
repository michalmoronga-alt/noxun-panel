...
13. [GHOST_OUTSIDE_IN_2026-09-04.md](GHOST_OUTSIDE_IN_2026-09-04.md) — **outside-in packet GHOST-D1/D2** (Tool/InputPoint/View/VCB kontrakty, logické pixely od SU 2025, pasce `String#to_l` a desatinnej čiarky, natívne `Sketchup::Snap`, prior art Rectangle → Push/Pull) + reconcile do draftov.
12. [NASTROJE1_PACKAGE_DRAFT_2026-09-04.md](NASTROJE1_PACKAGE_DRAFT_2026-09-04.md) — **DRAFT package NÁSTROJE-1** (Mower + Snaper v balíku enginu) po Codex CLI audite a GH kolách #288 1–3, s nálezmi kola 3 na zapracovanie; do PLANu sa vráti po novom CLI audite draftu.
