...
- **D-53 · UNI materiál — modelovanie bez záväzku** (Michal 31.7. večer) — pri modelovaní bez jasných materiálov zvoliť **UNI**: univerzálny materiál použiteľný všade, bez ceny/kódov; hrúbka/dekor neobmedzujú prácu a konkrétne materiály sa navolia **aj na konci** projektu. Potreba: „nebyť obmedzovaný hrúbkou alebo dekormi, kým ich nepoznám". *Stav: **z väčšej časti VYRIEŠENÉ PR #103 (M-B1, 1.8.)** — 5 UNI materiálov, hrúbku určuje dielec (doska aj 12 mm), semafor „materiál neurčený" (v KONTROLE viditeľné, nie ticho), ABS/ceny pre UNI zakázané. Zvyšok (dlaždice s badge, „Nahradiť UNI…" hromadná zámena s rozpisom) = dávka M-B2.*
