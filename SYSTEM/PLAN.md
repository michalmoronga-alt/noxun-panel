...
Nehotové zvyšky bloku ostali v živom pláne: **D-114** balík Čiel (s D-119 a D-120) v bloku **4 · V1 DOTIAHNUTIE**, zoznam **Mimo V1** v sekcii **Po V1 — zásobník**.)*
...
- **BALÍK ČIEL (D-114 + D-119 + D-120) — UI/UX dávka kontextu Čelá** *(presunuté sem 10.9.2026 pri uzávere bloku KOVANIE; dovtedy visela na jeho konci — celý obsah karty čela je
  odteraz známy: typy z KOV-A, zámky osí a systém zásuvky z KOV-C/D, závesy z KOV-F, výklopy z KOV-E)*. Plné znenia v [DOGFOODING.md](DOGFOODING.md), skupina **Balík Čiel**:
  **D-114** rad piktogramov namiesto textových tlačidiel „+ pridaj dvere" / „+ pridaj čelo" (tie isté sprite ikony ako typegrid karty, klik = nový riadok daného typu, **ten istý
  jeden riadok** ako dnešné dve tlačidlá) + upratanie kontextu Čelá · **D-119** presah dverí do strán **per strana** (dnes jedna hodnota `gap_sides`; hore/dole už zvlášť sú →
  config čela, **CONFIG_SCHEMA bump**) · **D-120** úchytkový profil (UKW) aj na **dolnej a bočných** hranách (registry `front_profiles` hranu dnes nepozná → config + registry/API
  + všetci konzumenti: `Fronts`, pravidlo kovania, renderer, náhľad, UI). **Audit ÁNO** kvôli D-119/D-120 (schémová zmena configu čela + registry kontrakt); D-114 samo je čisté UI.
