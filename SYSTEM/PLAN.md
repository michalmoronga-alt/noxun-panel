...
- **ŠT-3** (M) **Kovanie · Pravidlá · Šablóny** (Š16–Š18) — tri okná zanikajú. *Rez (23.8.):* ~~**3a-1** sekcia Kovanie — čítanie + KATALÓGOVÉ zápisy, okno ešte žije (#216, v0.7.58)~~ — **HOTOVÉ** · **3a-2** modelové zápisy (predvoľby setov projektu) + **zánik okna Katalóg kovania** + in-SketchUp sekcia · **3b** Pravidlá (Š17 — zjednotenie dvoch okien) · **3c** Šablóny (Š18).
