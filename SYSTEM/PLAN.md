...
- **NÁSTROJE-1 (Mower + Snaper v balíku Noxun Engine, D-20) — DRAFT MIMO PLANU:** package je po Codex CLI audite a GH kolách #288 (1–3) v [zdroje/next_sessions/NASTROJE1_PACKAGE_DRAFT_2026-09-04.md](zdroje/next_sessions/NASTROJE1_PACKAGE_DRAFT_2026-09-04.md)
  (nezáväzný podklad, outside-in packet hotový). Do PLANu sa vráti ako autorita samostatným docs PR po zapracovaní nálezov kola 3 a novom Codex CLI audite draftu.
- **GHOST-D1 · GHOST-D2 (ghost pre dosky, kreslenie na rozmer) — DRAFT MIMO PLANU:** packages sú po Codex kolách #288 v [zdroje/next_sessions/GHOST_D1_D2_PACKAGE_DRAFT_2026-09-04.md](zdroje/next_sessions/GHOST_D1_D2_PACKAGE_DRAFT_2026-09-04.md)
  (nezáväzný podklad). Do PLANu sa vrátia ako autorita až po **outside-in researchi** (natívny Tool, inference, Measurements/VCB) a zapracovaní nálezov kola 2 — samostatným docs PR.
