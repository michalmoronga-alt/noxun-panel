...
> ⚠️ **ARCHÍV — historický pracovný dokument (presunuté 24.7.2026).** Záväzná verzia je [../STANDARD.md](../STANDARD.md); pri rozpore platí štandard. Osnova sa ponecháva ako záznam rozhodovania. Legenda: ✅ = rozhodnuté · 🔶 = smer daný · ❓ = otvorené (stav k 15.7.).
