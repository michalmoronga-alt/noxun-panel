...
> ✅ **ARCHÍV — UZAVRETÉ (presunuté 24.7.2026):** Inspector-first implementovaný vo V0.4.5, okno Výroba vo V0.5. Otvorený ostáva len budúci Vkladač (Picker 2.0 — po V1 s knižnicou modulov); zoznam funkcií na vyoperovanie z Noxun Pick je nižšie v texte.
