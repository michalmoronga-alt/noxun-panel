...
(skrinka · slot umývačky · doska · len zákazka), cena len v Rozpočte, „dodáva zákazník" · **slot umývačky** ako prvý typ skrinky bez korpusu (čelo „Dv myčka", telo ako
referencia, výška čela z linky, soklu a medzery hore) · **chladnička v skrinke**: kontrolný box niky s pásmami dverí, Kontrola niky po osiach a odporúčané delenie čiel,
výška osadenia · **očakávaný spotrebič** zo šablóny aj z riadku Spotrebič s ORANGE „spotrebič nevybraný".
Dávky: E0 #375 · A1 #377 · A2 #378 · E #381 · B1 #382 · B2 #383 · F #384 · C #385; podporné #373 (listy), #376 (docs), #379/#380 (runner). Smoke Michala od 21.9. →
opravy A #386 · B1 #387 · B2 #388 · C #389 (D-136 až D-140); D-141 a D-142 v zásobníku. Pri poslednej dávke 4545 headless · 129 JS sád · 3081 in-SketchUp PASS / 0 FAIL.
Výsledok, dávky, overenie a checklist po aktualizácii: [S1_ZAVER_2026-09-24.md](S1_ZAVER_2026-09-24.md). Kompatibilita: skrinka schéma 18, šablóny STD 6, rozpočet
BUDGET_STD 2 — aktualizovať obe PC. **Vedomé revízie mockupu zo smoke:** výplň nad umývačkou je samostatný nízky korpus (R13/R14/R16), výška čela slotu sa dopočíta.
...
- **S1-D · Uzáver bloku** *(✅ PR #390, v0.13.0 — docs a verzia)* — V1_VIZIA, archív, STAV, KRONIKA, README, POJMY; výsledok, dávky a checklist po aktualizácii v [S1_ZAVER_2026-09-24.md](S1_ZAVER_2026-09-24.md).

## BLOK M-R VZHĽAD — UZAVRETÝ (12.9.2026, v0.12.0, PR #353–#359)
