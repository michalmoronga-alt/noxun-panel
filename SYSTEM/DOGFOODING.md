...
- **D-114 · Rad piktogramov namiesto tlačidiel „+ pridaj dvere" / „+ pridaj čelo" + upratanie kontextu Čelá** (Michal 3.9., smoke v0.9.20 po KOV-A) — nové čelo sa má pridávať
  ...
  **Spresnenie 11.9.:** schválený jeden rad šiestich typov vrátane „Bez čela“; profil a hrana v karte konkrétneho čela + hromadná skupina Úchytky. Packages ČELÁ-A/B/C sú v PLAN.md; mockup aj implementácia schválené, A aj B sú implementované (PR #347/#348), nasleduje C.
