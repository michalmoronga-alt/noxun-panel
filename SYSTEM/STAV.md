...
**Testy k v0.9.47:** **3429 headless** · 96 JS sád · posledný plný in-SketchUp beh **1965 PASS** (nad mainom v0.9.46, 8.9.; nestabilný test = D-117; sekcia `run_kovw` napísaná, beh čaká).
