...
**D-131 (najnovšie):** **4071 headless · 117 JS sád · 2687 in-SketchUp PASS / 0 FAIL** (29 kontrol sekcie `run_d131`: snapshoty dielcov, presne jeden krok Späť pre celú zákazku, „Bez čela"/doska/korpus aj VNORENÁ skrinka bajtovo nedotknuté, flush blokáda, cudzí `model_guid` aj prázdna zákazka bez kroku Späť).
