...
**Testy k v0.9.40:** **3302 headless** · 93 JS sád · posledný plný in-SketchUp beh **1815 PASS** (nad vetvou KOV-D1a, 6.9.; sekcie `run_kovd2a`, `run_kovd2b`, `run_kovd3a` a `run_kovd3b` čakajú na najbližší plný beh).
