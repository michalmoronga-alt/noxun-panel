...
**Testy k v0.9.40:** **3292 headless** · 93 JS sád · posledný plný in-SketchUp beh **1815 PASS** (nad vetvou KOV-D1a, 6.9.; sekcie `run_kovd2a`, `run_kovd2b`, `run_kovd3a` a `run_kovd3b` čakajú na najbližší plný beh).
...
- **Staršie uzávery** (**KOV-C1 + C2a** nemenné recepty, SHA register, 4. materiálový kanál a 8 setov s kódmi v0.9.29–v0.9.30 · **GHOST-D2** doska sa dá nakresliť na rozmer v0.9.28 ·
