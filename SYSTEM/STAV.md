...
**Testy k v0.9.41:** **3320 headless** · 94 JS sád · posledný plný in-SketchUp beh **1815 PASS** (nad vetvou KOV-D1a, 6.9.; sekcie `run_kovd2a`, `run_kovd2b`, `run_kovd3a`, `run_kovd3b` a `run_kovd4` čakajú na najbližší plný beh).
