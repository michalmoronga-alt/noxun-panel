...
**v0.12.8 · 20.9.2026 — M-R VZHĽAD KOMPLET, nad ním sedem dávok D-94 až D-130** (S1-E0 = v0.12.9 čaká v PR #375, merguje sa hneď po tomto docs PR · (Nákup s pôvodom · výška dreveného boxu · Kresba čiel · dormantný zámok ·
...
(`zdroje/ui20/mockup_spotrebice_s1.html`), packages v [PLAN.md](PLAN.md) blok 5. Poradie: **S1-E0** (min výška korpusu 80, PR #375 v review) → A1 katalóg → A2 sekcia → E slot umývačky → B väzba →
