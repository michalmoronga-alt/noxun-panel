...
- **GHOST VKLADANIE — skrinka sa kladie KLIKOM** (v0.8.22) **+ GHOST-FB** (v0.8.24, 31.8.): v zámku sa ghost prichytáva na rohy a hrany existujúcich skriniek (výšku drží zámok) · kotva skočí pod kurzor aj po Alt · kotva/otočenie/režim/výška sa pamätajú do zatvorenia SketchUpu ·
  **Ghost pásik** s prestaviteľnou zamknutou výškou (0 / 1400), od **v0.8.25** stojí samostatne **hneď pod sektorom Náhľad** (zbalený sektor ho už neschová) a **predná stena ghostu je jasná zelená** (tmavý teal splýval s obrysom) · **Michal večer: SMOKE — 11 bodov v [PLAN.md](PLAN.md); dvojklik na šablónu → pásik hneď vidno hore pod Náhľadom.**
