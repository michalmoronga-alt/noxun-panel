...
**v0.11.3 · 11.9.2026 — M-R: MR-1B2 ZACHOVANIE VZHĽADU PRI PRESTAVBE A KÓPII.** Plugin má **dve okná**: **Inspector** (čo je označené a čo s tým) a **Štúdio** (celá zákazka na jednom mieste)
