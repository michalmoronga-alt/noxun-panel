...
- Práve beží: **Materiály 2.0 — dávka M-B2 (dlaždice s UNI badge, „Nahradiť UNI…" s rozpisom dopadu pred potvrdením — nové sedenie)**; potom **D — mapovanie flagov kovania → zoznamy kódov setov** (⚠ pred D user-debata s Michalom; SET A kompletný 104717+106412+105408+105425), potom E (ceny v sumári + „Prepočítať ceny").
