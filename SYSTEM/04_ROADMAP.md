...
- Práve beží: **M-A3 — opravná dávka zo smoke testu 1.8.** (D-59 označenie „už v katalógu“ podľa kódu · D-60 viditeľná URL väzba + D-56 badge · D-64 ABS bez brand checku · D-65 slug prefixy zo sitemap; potom D-58/61/62/63), následne **Materiály 2.0 — dávka M-B2 (dlaždice s UNI badge, „Nahradiť UNI…" s rozpisom dopadu pred potvrdením — nové sedenie)**; potom **D — mapovanie flagov kovania → zoznamy kódov setov** (⚠ pred D user-debata s Michalom; SET A kompletný 104717+106412+105408+105425), potom E (ceny v sumári + „Prepočítať ceny").
