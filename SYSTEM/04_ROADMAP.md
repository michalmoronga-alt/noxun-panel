...
| 17.7. | **„Použiť na podobné" úplne odstrániť** (rozhodnutie Michala — nefixovať N-undo správanie, funkcia ide von; vráti sa premyslená až s kovaním) | 🔨 beží (vetva fix/remove-apply-to-similar) |
