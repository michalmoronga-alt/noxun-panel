# Noxun Engine — roadmapa (živý dokument, aktualizované 31.7.2026)
...
- **M-A3b HOTOVÁ (PR #107, v0.5.22)** — viditeľnosť väzieb: D-59 „už v katalógu“ podľa kódu (informatívne, nie zámok) · D-60 ikona väzby s dátumom + „Otvoriť u dodávateľa“ (URL len zo servera, re-sanitize — audit BLOCKER) + D-56 badge dlaždice · D-62 fotka v detaile · D-63 dvojriadkové názvy + tooltip · D-55 výrazný pás existujúcej skupiny.
- Práve beží: **M-A3c — editor variantov (BLOKERY smoke F8100: D-67 výber typu z ponuky nereaguje — CEF datalist → vlastný suggest; D-68 formát pre dopísané hrúbky — zástena sa nedá založiť; audit hotový, 3 BLOCKER zapracované vrát. gramatiky „9,2“)**; potom zvážiť **D-66 zástena z Demosu** (mini dávka), následne **Materiály 2.0 — dávka M-B2 (dlaždice s UNI badge, „Nahradiť UNI…” s rozpisom dopadu pred potvrdením — nové sedenie)**; potom **D — mapovanie flagov kovania → zoznamy kódov setov** (⚠ pred D user-debata s Michalom; SET A kompletný 104717+106412+105408+105425), potom E (ceny v sumári + „Prepočítať ceny“).
