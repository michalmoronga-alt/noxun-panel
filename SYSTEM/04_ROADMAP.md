...
- **M-A3e HOTOVÁ (PR #112, v0.5.25)** — D-71: pole „Demos URL“ v edit formulári variantu (ručné previazanie; sanitize, zmena/zmazanie ruší dátum overenia, UNI bez poľa; batch vedome bez URL — previaže sa editom po vytvorení). D-49 potvrdené Michalom (duplák automaticky — návrhová dávka pred/pri M-B2). Ďalej zvážiť **D-66 zástena z Demosu** (mini dávka), následne **Materiály 2.0 — dávka M-B2 (dlaždice s UNI badge, „Nahradiť UNI…” s rozpisom dopadu pred potvrdením — nové sedenie)**; potom **D — mapovanie flagov kovania → zoznamy kódov setov** (⚠ pred D user-debata s Michalom; SET A kompletný 104717+106412+105408+105425), potom E (ceny v sumári + „Prepočítať ceny“).
