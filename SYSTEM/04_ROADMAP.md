...
- **M-A3c HOTOVÁ (PR #109, v0.5.23)** — editor variantov (BLOKERY smoke F8100): D-67 vlastný suggest dropdown namiesto CEF datalistu (mousedown, šípky/Enter/Escape, diakritika; typ, výrobca aj inline editor) · D-68 pruh „Formát výnimiek“ pre dopísané hrúbky — zástena 9,2 sa dá založiť; nová gramatika desatinnej čiarky (9,2 = 9,2 mm, koniec tichého rozpadu 9,20 → 9+20). **M-A3 KOMPLET.** Ďalej zvážiť **D-66 zástena z Demosu** (mini dávka), následne **Materiály 2.0 — dávka M-B2 (dlaždice s UNI badge, „Nahradiť UNI…” s rozpisom dopadu pred potvrdením — nové sedenie)**; potom **D — mapovanie flagov kovania → zoznamy kódov setov** (⚠ pred D user-debata s Michalom; SET A kompletný 104717+106412+105408+105425), potom E (ceny v sumári + „Prepočítať ceny“).
