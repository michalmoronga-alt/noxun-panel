...
- **M-A3d HOTOVÁ (PR #111, v0.5.24)** — D-70: „Aktualizovať z Demosu“ číta uloženú väzbu (variant s demos_url priamo, match len pre nezviazané; funguje aj bez sitemap; zastaraná väzba = jasná hláška) — mechanický základ „Prepočítať ceny“ dávky E. Ďalej zvážiť **D-66 zástena z Demosu** (mini dávka), následne **Materiály 2.0 — dávka M-B2 (dlaždice s UNI badge, „Nahradiť UNI…” s rozpisom dopadu pred potvrdením — nové sedenie)**; potom **D — mapovanie flagov kovania → zoznamy kódov setov** (⚠ pred D user-debata s Michalom; SET A kompletný 104717+106412+105408+105425), potom E (ceny v sumári + „Prepočítať ceny“).
