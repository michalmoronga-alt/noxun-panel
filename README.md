...
Kontrakty: BuildPlan (geometria, kusovník aj VEPO čítajú ten istý plán) + výrobný snapshot na entite (štandard 8.2/8.3). Testy: **738 headless + 574 JS (CI na každý push) + ~140 in-SketchUp scenárov**. Ďalej vo V0.6: **M-B2 (UNI dlaždice + „Nahradiť UNI…"), D — sety kovania, E — ceny v sumári** — viď roadmapa.
