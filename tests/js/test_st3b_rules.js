...
// --- KOV-F2: door guardy sú EDITOR, nie read-only veta ----------------------
// F1 ich vedela len priznať jednou vetou (`rdGuardHint`); F2 z nich urobila
// formulár, takže veta zanikla — jej rolu prevzal SÚHRN v zbalenej lište.
// Kreslenie, zber hodnôt a klientska validácia guardov žijú vo vlastnej sade
// `tests/js/test_kovf2_editor_zavesy.js`; tu ostáva len to, že z tohto súboru
// read-only veta naozaj ZMIZLA (inak by ten istý údaj bol na obrazovke dvakrát).
(function(){
  ok(typeof R.rdGuardHint === 'undefined',
     'read-only veta F1 zanikla — guardy sa editujú, nie opisujú');
  ok(typeof R.rdGuardSummary === 'function' && typeof R.rdGuardHtml === 'function',
     'a nahradil ju editor so súhrnom (F2)');
})();
