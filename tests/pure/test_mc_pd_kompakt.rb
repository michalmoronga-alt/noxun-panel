...
NxTest.test('mc: normalize_sheet — pole prezije LEN pri PD; required_schema_for = 8') do
  ...
  # Novsie obsahove markery nemenia minimum pre povodny PD kontrakt.
  NxTest.assert(MCM::SCHEMA_CURRENT >= MCM::SCHEMA_PD_EDGE, 'aktualna schema podporuje PD marker')
end
