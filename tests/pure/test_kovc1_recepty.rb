...
NxTest.test('KOV-C1: register kodov konfliktov ma presne 12 poloziek (D-128: +box_lock_invalid)') do
  NxTest.assert_equal(12, NxKovC1.r::CONFLICT_CODES.size)
  %w[drawer_unclassified drawer_no_fit drawer_obstruction drawer_internal_unsupported
     ...
     drawer_kit_missing].each do |code|
